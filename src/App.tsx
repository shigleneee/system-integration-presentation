...
const masterImages = [
  { url: "/s1.png", label: "Logic Flow A", color: "text-emerald-400" },
  { url: "/office2.png", label: "Architecture B", color: "text-blue-400" },
  { url: "/office2.png", label: "Use Case C", color: "text-purple-400" },
  { url: "/office2.png", label: "Database D", color: "text-amber-400" },
];
            ...
            >
              <div className="relative h-[70vh] group">
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="relative w-full h-full rounded-2xl overflow-hidden border border-white/5 bg-neutral-950/50">
                      ...
                      <img 
                        src={masterImages[masterImageIndex].url} 
                        alt={masterImages[masterImageIndex].label} 
                      ...
                      <div className="absolute bottom-6 left-6 px-4 py-2 bg-neutral-950/50 backdrop-blur-md rounded-lg border border-white/10">
                        ...
                        <p className={cn(
                          ...
                          masterImages[masterImageIndex].color
                        )}>
                          {masterImages[masterImageIndex].label}
                        </p>
                      </div>
                    </div>
                  </motion.div>
                ...
                <div className="absolute inset-y-0 left-4 flex items-center">
                  <button 
                    onClick={() => setMasterImageIndex(prev => (prev === 0 ? masterImages.length - 1 : prev - 1))}
                  ...
                  >
                    {/* This is your left arrow (rotate-180) */}
                ...
                <div className="absolute inset-y-0 right-4 flex items-center">
                  <button 
                    onClick={() => setMasterImageIndex(prev => (prev === masterImages.length - 1 ? 0 : prev + 1))}
                    className="p-3 bg-neutral-950/50 hover:bg-neutral-950/80 backdrop-blur-md rounded-full text-white transition-all border border-white/10 opacity-0 group-hover:opacity-100"
                  >
