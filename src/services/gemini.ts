...
export async function generateQuestions() {
  ...
  { 
    ...
    answer: [
      ...
      "Шинжилгээний явцад шаардлагыг бизнес эрхлэгчийн үүднээс бичиж, системийн ЮУ гэдэг асуулт дээр төвлөрүүлдэг. Эдгээр нь бизнесийн хэрэглэгчийн хэрэгцээнд төвлөрдөг тул тэдгээрийг ихэвчлэн бизнесийн шаардлага (заримдаа хэрэглэгчийн шаардлага) гэж нэрлэдэг.",
      " Хожим нь дизайны үед бизнесийн шаардлага илүү техникийн болж хувирдаг бөгөөд системийг хэрхэн хэрэгжүүлэхийг тодорхойлдог. Дизайн дахь шаардлагыг хөгжүүлэгчийн үүднээс бичиж, ихэвчлэн системийн шаардлага гэж нэрлэдэг."
    ]
  },
  { 
    id: 4,
    ...
    answer: [
     " 1. Одоогийн нөхцөл байдлыг ойлгох",
      ...
      "RAD (Шурхай хөгжүүлэлт) эсвэл Agile (Уян хатан) аргачлалуудыг ашиглаж байгаа үед одоогийн системд анхаарахаас илүү шууд сайжруулалт болон ирээдүйн систем дээр төвлөрдөг.",
       "2. Сайжруулалтын боломжуудыг тодорхойлох",
       "Одоогийн системд юу дутагдаж байгаа болон юуг илүү дээр болгож болохыг илрүүлэх.",
       "3. Шинэ системийн шаардлагыг тодорхойлох.",
       "Шинээр бий болох систем ямар байх ёстойг тодорхойлж, түүнд тавигдах шаардлагуудыг гаргах.",
       "Фэйзээр хөгжүүлэх (phased development), прототайп хийх (prototyping), Скрам (Scrum) зэрэг орчин үеийн аргууд нь одоо байгаа зүйлийг судлахаас илүү ирээдүйд бий болох шаардлагад гол анхаарлаа хандуулдаг байна."
     ]
  },
  { 
    id: 5,
  ...
  },
  {
    id: 15,
    title: 'Асуулт 15',
    question: 'Баримт (facts) ба санал бодлыг (opinions) хэрхэн ялгах вэ? Яагаад хоёулаа хэрэгтэй байдаг вэ?',
    answer: [
      "Баримт (Facts): Объектив, хэмжигдэхүйц мэдээлэл.Жишээ: 'E-Zaal системд 10 заал бүртгэлтэй байна', 'Нэг цагийн төлбөр 50,000 төгрөг'.",
      "Санал бодол (Opinions): Субъектив, хувь хүний мэдрэмж, хандлага.Жишээ: 'Захиалгын цэс ойлгомжгүй байна', 'Систем удаан санагдаж байна'.",
      "Яагаад хоёулаа хэрэгтэй вэ? ",
      "Баримт нь системийн өнөөгийн бодит байдлыг (техникийн боломж) тодорхойлдог бол, санал бодол нь хэрэглэгчийн хэрэгцээ, сэтгэл ханамж болон цаашид сайжруулах шаардлагатай хэсгийг олж харахад тусалдаг."
    ]
  },
  {
    id: 16,
    title: 'Асуулт 16',
    question: ' JAD session явуулах 5 үндсэн алхмыг тайлбарла.',
    answer: [
     "1.Сэдвийг сонгох (Select Participants): Хэрэглэгч, менежер, шинжээчдийг зөв сонгож оролцуулах.",
     "2.Сессийг төлөвлөх (Design the Session): Хэлэлцэх асуудлын жагсаалт (Agenda) гаргах.",
     "3.Сессийг бэлтгэх (Prepare for the Session): Оролцогчдод урьдчилан мэдээлэл өгөх, орчин бүрдүүлэх.",
     "4.Сессийг явуулах (Conduct the Session): Facilitator-ийн удирдлага дор асуудлыг хэлэлцэж, шийдэл гаргах.",
     "5.Тайлагнах (Post-Session Report): Гарсан үр дүнг баримтжуулж, оролцогчдоор баталгаажуулах."
    ]
  },
  {
    id: 17,
    title: 'Асуулт 17',
    question: 'JAD facilitator ба Scribe хоёрын үүргийн ялгаа юу вэ?',
    answer: [
      "Facilitator (Чиглүүлэгч)",
      "Гол зорилго: Хэлэлцүүлгийг удирдах, төлөвлөгөөний дагуу явуулах. Оролцоо: Оролцогчдоос асуулт асууж, маргааныг зохицуулна.",
      "Scribe (Тэмдэглэгч)",
      "Гол зорилго: Хэлэлцүүлгийн явц, гарсан шийдвэрүүдийг баримтжуулах. Оролцоо: Хэлэлцүүлэгт оролцохгүй, зөвхөн тэмдэглэл хөтөлнө."
    ]
  },
  {
    id: 18,
    title: 'Асуулт 18',
    question: 'JAD session явуулахад facilitator-ийн гүйцэтгэдэг 3 үндсэн ажил юу вэ?',
    answer: [
      "1. Agenda-г дагах: Хэлэлцүүлгийг үндсэн сэдвээс хазайлгахгүй, цагт нь багтаан удирдах.",
      "2. Оролцоог хангах: Ичимхий оролцогчдыг яриулах, хэт давамгайлж буй оролцогчийг хязгаарлах замаар тэнцвэртэй байдлыг хангах.",
      "3. Нэгдсэн шийдэлд хүргэх: Зөрчилдөөнтэй саналуудыг нэгтгэж, эцсийн зөвшилцөлд хүрэхэд туслах."
    ]
  },
  {
    id: 19,
    title: 'Асуулт 19',
    question: 'e-JAD гэж юу вэ? Байгууллага яагаад үүнийг ашиглах сонирхолтой байдаг вэ? ',
    answer: [
      "e-JAD гэдэг нь JAD сессийг тусгай программ хангамж (Groupware) болон цахим хэрэгсэл ашиглан зайнаас эсвэл танхимд зохион байгуулахыг хэлнэ.",
      "1.Нэрээ нууцлах боломж: Бага тушаалын ажилтан дээд удирдлагаасаа эмээлгүй үнэн бодит санал өгөх боломжтой.",
      "2.Цаг хугацаа хэмнэх: Оролцогчид заавал нэг дор цуглах шаардлагагүй (зайнаас оролцох).",
      "3.Шууд баримтжуулалт: Санал, шийдвэрүүд системд шууд бичигдэж хадгалагддаг."
    ]
  },
  {
    id: 20,
    title: 'Асуулт 20',
    question: 'Questionnaire-ийн асуулт боловсруулах нь interview эсвэл JAD-ын асуулт боловсруулахтай юугаараа ялгаатай вэ?',
    answer: [ 
      "Анкет (Questionnaire) нь нүүр тулсан харилцаа байхгүй үед ашиглагддаг тул:",
      "Илүү тодорхой байх: Дахин тайлбарлах боломжгүй тул асуулт нь хоёрдмол утгагүй байх ёстой.",
      "Бүтэцлэгдсэн (Structured): Ихэвчлэн хаалттай асуултууд давамгайлдаг (Сонгох, эрэмбэлэх).",
      "Өөрийгөө тайлбарлах: Хэрэглэгч тусламжгүйгээр бөглөхөд хялбар зааварчилгаатай байх ёстой.",
      "Ялгаа нь: Interview эсвэл JAD-д асуултыг явц дунд нь өөрчилж, тодруулж болдог бол Questionnaire-д энэ боломжгүй."
    ]
  },
  {
    id: 21,
    title: 'Асуулт 21',
    question: 'Questionnaire-ийн хариу өгөх дундаж хувь хэд байдаг вэ? Үүнийг хэрхэн нэмэгдүүлэх вэ? ',
    answer: [ 
      "Дундаж хувь:",
      "Цаасан анкет: 30% - 50%",
      "Цахим анкет: 5% - 30% (маш бага байх хандлагатай)",
      "Хэрхэн нэмэгдүүлэх вэ?",
      "1.Урамшуулал олгох: (Жишээ нь: \"E-Zaal\" дээр анкет бөглөвөл заал захиалах 10% хөнгөлөлтийн купон өгөх).",
      "2.Богино байх: Асуултын тоог цөөрүүлж, 5-10 минутаас хэтрэхгүй болгох.",
      "3.Зорилгыг ойлгуулах: Таны санал системийн дараагийн шинэчлэлд шууд нөлөөлнө гэдгийг тайлбарлах.",
      "4.Дахин сануулах: Тодорхой хугацааны дараа эелдэг сануулга илгээх."
    ]
  },
  {
    id: 22,
