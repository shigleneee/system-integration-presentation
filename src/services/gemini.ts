...
export async function generateQuestions() {
  ...
  },
  {
    ...
    answer: [
      "Баримт (facts) нь бодитой, шалгагдсан мэдээлэл бөгөөд өөрийн үзэл бодолгүй байдаг. Жишээ нь: 'Манай одоогийн систем 5 жилийн турш ашиглагдаж байна.'",
      "Санал бодол (opinions) нь тухайн хүний үзэл бодол, сэтгэгдэл, үнэлгээ юм. Жишээ нь: 'Манай одоогийн систем удаан бөгөөд ашиглахад төвөгтэй байна.'",
      "Баримт нь асуудлын объектив байдлыг ойлгоход тусалдаг бол санал бодол нь хэрэглэгчдийн сэтгэл ханамж, хэрэгцээг ойлгоход чухал байдаг. Хоёулаа шинжилгээний процессын чухал хэсэг бөгөөд хоорондоо харилцан補完 (complementary) байдаг."
    ]
  },
  {
    id: 16,
    ...
    answer: [
      "1. Бэлтгэл (Preparation): JAD session-ийг явуулахын өмнө, оролцогчдыг тодорхойлох, шаардлагуудыг цуглуулах, хуралдааны зорилго, хөтөлбөрийг тодорхойлох.",
      "2. Оролцогчдыг танилцуулах (Introduction of Participants): Оролцогчид бие биенээ танилцуулах, үүрэг, хариуцлагыг тодорхойлох.",
      "3. Мэдээлэл цуглуулах (Information Gathering): Асуулт, ярилцлага, мозайк (brainstorming) зэрэг аргуудыг ашиглан шаардлагуудыг цуглуулах.",
      "4. Шаардлагуудыг тодорхойлох (Requirements Definition): Цуглуулсан мэдээллийг анализ хийх, шаардлагуудыг тодорхойлох, баталгаажуулах.",
      "5. Хуралдааныг дүгнэх (Session Wrap-up): Хуралдааны үр дүнг дүгнэх, дараагийн алхмуудыг төлөвлөх."
    ]
  },
  {
    id: 17,
    ...
    answer: [
      "JAD facilitator нь хуралдааныг удирдаж, оролцогчдыг идэвхтэй оролцохыг уриалж, хэлэлцүүлгийг чиглүүлэх үүрэгтэй.",
      "Scribe нь хуралдааны үеэр гарч буй бүх мэдээллийг тэмдэглэж, баримтжуулах үүрэгтэй."
    ]
  },
  {
    id: 18,
  ...
  },
  {
    ...
    answer: [
      "1. Оролцогчдын идэвхгүй байдал: Facilitator нь идэвхтэй оролцоог уриалж, тодруулах асуултууд тавих хэрэгтэй.",
      "2. Хэлэлцүүлгийн гацаа: Оролцогчид хоорондоо санал зөрөлдөх, эсвэл асуудлыг тодорхойлохгүй байх тохиолдолд, facilitator нь асуудлыг шийдвэрлэхэд туслах хэрэгтэй."
    ]
  },
  {
    id: 20,
    ...
    answer: [ 
      "Questionnaire-ийн асуулт боловсруулах нь илүү бүтэцтэй, стандартчилсан байдлаар хийгддэг.",
      "Interview эсвэл JAD-д асуулт боловсруулах нь илүү уян хатан, оролцогчдын хариултаас хамааран өөрчлөгдөх боломжтой."
    ]
  },
  {
    id: 21,
